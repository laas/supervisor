...
rosservice call /database_manager/set_info "{add: true, infoType: 'FACT', agentId: 'HERAKLES_HUMAN1', facts: [
    {property: 'isOn', propertyType: 'state', subProperty: '', subjectId: 'BLUE_CUBE1', targetId: 'RED_CUBE1', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 1.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0, timeStart: 0, timeEnd: 0}
    , {property: 'isOn', propertyType: 'state', subProperty: '', subjectId: 'RED_CUBE1', targetId: 'GREEN_CUBE2', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 1.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0, timeStart: 0, timeEnd: 0}
    , {property: 'isOn', propertyType: 'state', subProperty: '', subjectId: 'GREEN_CUBE2', targetId: 'RED_CUBE2', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 1.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0, timeStart: 0, timeEnd: 0}
    ...
    , {property: 'isOn', propertyType: 'state', subProperty: '', subjectId: 'BLUE_CUBE2', targetId: 'RED_CUBE2', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 1.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0, timeStart: 0, timeEnd: 0}
    , {property: 'isOn', propertyType: 'state', subProperty: '', subjectId: 'RED_CUBE2', targetId: 'BLUE_CUBE3', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 1.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0, timeStart: 0, timeEnd: 0}
    , {property: 'isOn', propertyType: 'state', subProperty: '', subjectId: 'RED_CUBE3', targetId: 'GREEN_CUBE3', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 1.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0, timeStart: 0, timeEnd: 0}
], event: {property: '', propertyType: '', subProperty: '', subjectId: '', targetId: '', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 0.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0}, id: '', name: '', ownerId: ''}"
