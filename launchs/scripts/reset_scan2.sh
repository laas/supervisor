...
rosservice call /database_manager/set_info "{add: true, infoType: 'FACT', agentId: 'HERAKLES_HUMAN1', facts: [
    {property: 'isOn', propertyType: 'state', subProperty: '', subjectId: 'RED_CUBE1', targetId: 'BLUE_CUBE1', subjectOwnerId: '', targetOwnerId: '', valueType: false, factObservability: 1.0, doubleValue: 0.0, stringValue: '', confidence: 0.0, time: 0, timeStart: 0, timeEnd: 0}
